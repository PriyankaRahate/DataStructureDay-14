...
public class MyNodeMain {
	    ...
	    */
	    public static INode<Integer> searchElementLinkedList(Integer search_key,Integer ...args){
	        ...
	        System.out.print("Linked List search : ");
	        myLinkedList.printMyNodes();
	    ...
	    */
	    ...
	    public static void main(String []args){
	        ...
	        createLinkedListAppend(30,56,70);
	       insertLinkedListElement(56,30,70);
	       popElementLinkedList(56,30,70);
	       deleteLastElementLinkedList(56,30,70);
	       searchElementLinkedList(56,30,70);
	       insertAfterSearchLinkedList(56,30,30);
	       deleteElementLinkedList(56,30,40,70);
